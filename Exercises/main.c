...
void check_memory (Cards *comp_deck, int **board, int rows, int col, int row_user, int col_user, int comp_mem) {
    int i = 0;
...
void add_memory (Cards *comp_deck, int **board, int rows, int col, int row_user, int col_user, int comp_mem) {
    int i = 0;
